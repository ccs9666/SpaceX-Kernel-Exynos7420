...
#32 IMG=arch/arm/boot
#32 DTS=arch/arm/boot/dts
#32 DC=arch/arm/configs
...
sed -i -e '/ui_print("~~~~~~~~~ SpaceX Kernel for/c\ui_print("~~~~~~~~~ SpaceX Kernel for Galaxy S6 Edge+ ~~~~~~~~~");' Output/META-INF/com/google/android/updater-script

sed -i -e '/by ManhIT ~~~~~~~~~~~~~~~");/c\ui_print("~~~~~~~~~~~~~~~ G928F/I/L/S/K - by ManhIT ~~~~~~~~~~~~~~~");' Output/META-INF/com/google/android/updater-script
